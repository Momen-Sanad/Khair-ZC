...
from models.dbSchema import db, User, Event, Registration 
...
def register_user_for_event(current_user):
    """
    ...
    new_registration = Registration(user_id=current_user.id, event_id=event_id)
