...
class RegistrationTestCase(unittest.TestCase):
    ...
    def test_register_user_for_campaign_missing_fields(self):
        ...
        data = json.loads(response.data)
        self.assertEqual(data['message'], "Campaign ID is required.")
    ...
    def test_register_user_for_campaign_invalid_campaign(self):
        ...
        data = json.loads(response.data)
        self.assertEqual(data['message'], "Campaign not fonud.")
        self.assertEqual(data['status'], "error")
    ...
    def test_register_user_already_registered(self):
        ...
        self.assertEqual(response.status_code, 400)
        data = json.loads(response.data)
        self.assertEqual(data['message'], "User is already registered.")
        self.assertEqual(data['status'], "error")
    ...
    def test_register_user_campaign_full(self):
        ...
        self.assertEqual(response.status_code, 400)
        data = json.loads(response.data)
        self.assertEqual(data['message'], "Campaign is full. Cannot register.")
        self.assertEqual(data['status'], "error")
    ...
    def test_remove_user_from_campaign_as_admin_success(self):
        ...
        self.assertEqual(response.status_code, 200)
        data = json.loads(response.data)
        self.assertEqual(data['message'], "Campaign removed successfully.")
        self.assertEqual(data['status'], "success")
    ...
    def test_remove_user_from_campaign_as_admin_user_not_registered(self):
        ...
        self.assertEqual(response.status_code, 404)
        data = json.loads(response.data)
        self.assertEqual(data['message'], "User is not registered.")
        self.assertEqual(data['status'], "error")
